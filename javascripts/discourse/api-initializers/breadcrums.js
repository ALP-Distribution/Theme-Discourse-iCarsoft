        ...
        success: function (response) {
          if (response && response.title) {
            ...
            $.ajax({
              ...
              success: function (categoryResponse) {
                if (categoryResponse && categoryResponse.category) {
                  ...
                  const parentCategoryId =
                    categoryResponse.category.parent_category_id;
                  ...
                  if (parentCategoryId) {
                    $.ajax({
                      ...
                      success: function (parentResponse) {
                        ...
                        const catSubcatURL = `/c/${
                          parentResponse?.category?.slug || ""
                        }/${categoryResponse?.category?.slug || ""}`;
                      ...
                      error: function (error) {
                        console.error(
                          "Error fetching parent category details for topic",
                          error
                        );
                      },
                    });
              ...
              error: function (error) {
                console.error(
                  "Error fetching category details for topic",
                  error
                );
              },
            });
